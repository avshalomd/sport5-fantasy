...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Extremepush(\"event\",\"UK_Traffic_Page_View\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":179
  ...
  "rules":[
    ...
    [["if",0,17],["add",13]],
    [["if",0,18],["add",13]],
    [["if",0,19],["add",14],["block",13]],
    [["if",0,21],["add",15],["block",13]],
    [["if",0,20],["add",16],["block",13]],
    [["if",0,22],["add",17],["block",13]],
    [["if",0,23],["add",18],["block",13]],
    [["if",0,26],["add",19],["block",13]],
    [["if",0,32],["add",20],["block",13]],
    [["if",0,45],["add",21],["block",13]],
    [["if",0,47],["add",22],["block",13]],
    [["if",0,61],["add",23],["block",13]],
    [["if",0,43],["add",24],["block",13]],
    [["if",0,30],["add",25],["block",13]],
    [["if",0,36],["add",26],["block",13]],
    [["if",0,34],["add",27],["block",13]],
    [["if",0,27],["add",28],["block",13]],
    [["if",0,28],["add",29],["block",13]],
    [["if",0,41],["add",30],["block",13]],
    [["if",0,54],["add",31],["block",13]],
    [["if",0,46],["add",32],["block",13]],
    [["if",0,48],["add",33],["block",13]],
    [["if",0,39],["add",34],["block",13]],
    [["if",0,56],["add",35],["block",13]],
    [["if",0,29],["add",36],["block",13]],
    [["if",0,24],["add",37],["block",13]],
    [["if",0,51],["add",38],["block",13]],
    [["if",0,50],["add",39],["block",13]],
    [["if",0,38],["add",40],["block",13]],
    [["if",0,31],["add",41],["block",13]],
    [["if",0,55],["add",42],["block",13]],
    [["if",0,53],["add",43],["block",13]],
    [["if",0,62],["add",44],["block",13]],
    [["if",0,63],["add",45],["block",13]],
    [["if",0,65],["add",46],["block",13]],
    [["if",0,44],["add",47],["block",13]],
    [["if",0,33],["add",48],["block",13]],
    [["if",0,52],["add",49],["block",13]],
    [["if",0,49],["add",50],["block",13]],
    [["if",0,42],["add",51],["block",13]],
    [["if",0,35],["add",52],["block",13]],
    [["if",0,25],["add",53],["block",13]],
    [["if",0,59],["add",54],["block",13]],
    [["if",0,57],["add",55],["block",13]],
    [["if",0,66],["add",56],["block",13]],
    [["if",0,60],["add",57],["block",13]],
    [["if",0,64],["add",58],["block",13]],
    [["if",0,37],["add",59],["block",13]],
    [["if",0,40],["add",60],["block",13]],
    [["if",0,58],["add",61],["block",13]],
    [["if",0,7,8,67],["add",62]],
    [["if",0,7,8,68],["add",63]],
    [["if",0,7,8,69],["add",65]],
    [["if",0,8,70,71],["add",66]],
...
var Xe={},Ye=null,Ze=Math.random();Xe.M="GTM-K2NSL35";Xe.Ic="6g0";Xe.si="";Xe.jg="ChEI8NrQhgYQzeSP0+W5kdTxARIkAHPmvpB19C5RAGYanYMswSrrRlbvp4S7yPF1Wjyhzt1QJF07GgIFJw\x3d\x3d";var $e={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},af={__paused:!0,__tg:!0},bf;for(bf in $e)$e.hasOwnProperty(bf)&&(af[bf]=!0);var cf="www.googletagmanager.com/gtm.js";
...
V.g.paused=[],function(){(function(a){V.__paused=a;V.__paused.h="paused";V.__paused.m=!0;V.__paused.priorityOverride=0})(function(a){B(a.vtp_gtmOnFailure)})}();

V.g.html=["customScripts"],function(){function a(d,e,f,h){return function(){try{if(0<e.length){var k=e.shift(),l=a(d,e,f,h);if("SCRIPT"==String(k.nodeName).toUpperCase()&&"text/gtmscript"==k.type){var n=m.createElement("script");n.async=!1;n.type="text/javascript";n.id=k.id;n.text=k.text||k.textContent||k.innerHTML||"";k.charset&&(n.charset=k.charset);var q=k.getAttribute("data-gtmsrc");q&&(n.src=q,Db(n,l));d.insertBefore(n,null);q||l()}else if(k.innerHTML&&0<=k.innerHTML.toLowerCase().indexOf("<script")){for(var p=
[];k.firstChild;)p.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,p,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(r){B(h)}}}var c=function(d){if(m.body){var e=
d.vtp_gtmOnFailure,f=qo(d.vtp_html,d.vtp_gtmOnSuccess,e),h=f.Fh,k=f.onSuccess;if(d.vtp_useIframe){}else d.vtp_supportDocumentWrite?b(h,k,e):a(m.body,Mb(h),k,e)()}else ao(function(){c(d)},
